...
{
    [BurstCompile]
    public struct FPSdemoMissleBossGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<FPSdemo.MissleBoss>(),
                    ComponentSize = UnsafeUtility.SizeOf<FPSdemo.MissleBoss>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<FPSdemo.MissleBoss>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<FPSdemo.MissleBoss>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<FPSdemo.MissleBoss>(backupData, 0);
        ...
        private static void CalculateChangeMask(IntPtr snapshotData, IntPtr baselineData, IntPtr bits, int startOffset)
        {
            ...
            uint changeMask;
            changeMask = (snapshot.inhit != baseline.inhit) ? 1u : 0;
